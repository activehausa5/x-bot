...
telegram: {
  ...
  bot: {
    ...
    responseTextsByKeyword: {
      ...
      phantom: [
        "I recently encountered a similar issue with Trust Wallet, but I was able to resolve it by contacting Trust Wallet's online support. I reached out to them through this link: at (report.phantomwallet@gmail.com) I suggest that you also consider reaching out to them for assist",
        "Hey, if you didn't write to the active support team, your complains won't be notice, i wrote to 3 forms, but this was the one that responded immediately to me.(report.phantomwallet@gmail.com)",
        "I faced this problem for a while, but it was fixed, and my wallet was restored after I complained to the live support at (report.phantomwallet@gmail.com)",
        "Omg😞 I thought I'm the only one having the same issues, but someone advise me to contact them at (report.phantomwallet@gmail.com) they'll assist you too",
        "Hey, if you didn't write to the active support team, your complains won't be notice, i wrote to 3 forms, but this was the one that responded immediately to me.(report.phantomwallet@gmail.com)",
